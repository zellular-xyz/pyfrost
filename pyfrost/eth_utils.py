...
from pyfrost.crypto_utils import pub_to_addr, lagrange_coef, N, code_to_pub, ecurve, pub_decompress


def eth_challenge(group_pub_key: Dict, message_hex: str, aggregated_public_nonce: Point) -> bytes:
